...
import com.drop.service.edu.entity.vo.TeacherQuery;
...
public class EduTeacherController {
    ...
    public R pageListTeacher(@PathVariable long current,
        ...
        try {
            ...
            //执行自定义异常
            throw new DropException(20001,"执行了自定义异常处理....");
        }
...
//        return R.ok().data(map);
    ...
    @GetMapping("countTeacherDaily/{day}")
    public R countTeacherDaily(@PathVariable String day){
        Integer count = teacherService.countTeacherByDay(day);
        return R.ok().data("teacherNumDaily", count);
    }
